...
import { closeWidgetRoute, expandWidgetRoute } from 'pc/components/widget/expand_widget';
import { useDevLoadCheck, useFullScreen } from 'pc/components/widget/hooks';
import { usePreLoadError } from 'pc/components/widget/hooks/use_pre_load_error';
import { ErrorWidget } from 'pc/components/widget/error_widget';
import { IWidgetPropsBase } from './interface';
import styles from './style.module.less';
import { IWidgetBlockRefs, WidgetBlock } from './demo_widget_block';
import { useManageWidgetRenderTask } from 'pc/components/widget/context';
